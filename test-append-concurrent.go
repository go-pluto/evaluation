...
func PlutoTester(start chan struct{}, done chan struct{}, plutoC *conn.Conn, connNum int, runs int, plutoLogFolder string, logFileTime time.Time, appendMsg *bytes.Buffer, appendMsgSize int) {
...
func DovecotTester(start chan struct{}, done chan struct{}, dovecotC *conn.Conn, connNum int, runs int, dovecotLogFolder string, logFileTime time.Time, appendMsg *bytes.Buffer, appendMsgSize int) {
